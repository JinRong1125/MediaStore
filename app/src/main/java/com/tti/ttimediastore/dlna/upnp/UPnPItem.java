...
public class UPnPItem {
    ...
    protected UPnPItem(int icon) {
        this(icon, null, false, null, null, null);
    }

    public UPnPItem(int icon, String title, String description) {
        this(icon, null, false, title, description, null);
    }

    public UPnPItem(int icon, String iconUrl, Boolean hideIcon, String title,
