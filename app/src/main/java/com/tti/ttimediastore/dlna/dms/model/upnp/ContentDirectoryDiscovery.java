...
public class ContentDirectoryDiscovery extends DeviceDiscovery {
	...
	{
		if (ServiceManager.upnpServiceController != null && ServiceManager.upnpServiceController.getSelectedContentDirectory() != null)
			return device.equals(ServiceManager.upnpServiceController.getSelectedContentDirectory());
	...
	{
		ServiceManager.upnpServiceController.setSelectedContentDirectory(device, force);
	}
	...
	{
		if (ServiceManager.upnpServiceController != null && ServiceManager.upnpServiceController.getSelectedContentDirectory() != null
				&& d.equals(ServiceManager.upnpServiceController.getSelectedContentDirectory()))
			ServiceManager.upnpServiceController.setSelectedContentDirectory(null);
	}
}
