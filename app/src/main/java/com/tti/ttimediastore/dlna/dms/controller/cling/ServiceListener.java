...
import com.tti.ttimediastore.dlna.dms.model.cling.CDevice;
import com.tti.ttimediastore.dlna.dms.model.cling.CRegistryListener;
import com.tti.ttimediastore.dlna.dms.model.mediaserver.MediaServer;
import com.tti.ttimediastore.dlna.dms.model.upnp.ICallableFilter;
import com.tti.ttimediastore.dlna.dms.model.upnp.IRegistryListener;
import com.tti.ttimediastore.dlna.dms.model.upnp.IServiceListener;
import com.tti.ttimediastore.dlna.dms.model.upnp.IUpnpDevice;
...
public class ServiceListener implements IServiceListener
{
	...
	protected ServiceConnection serviceConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName className, IBinder service)
		{
			...
			if(sharedPref.getBoolean(Constants.CONTENTDIRECTORY_SERVICE, true))
			{
				try
				{
	...
	public void startMediaServer() {
		Log.i(TAG, "Service connexion");
		upnpService = ServiceManager.androidUpnpService;
