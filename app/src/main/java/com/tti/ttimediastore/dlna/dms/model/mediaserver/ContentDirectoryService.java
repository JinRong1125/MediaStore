...
package com.tti.ttimediastore.dlna.dms.model.mediaserver;
...
import com.tti.ttimediastore.dlna.dms.model.cling.localContent.AlbumContainer;
import com.tti.ttimediastore.dlna.dms.model.cling.localContent.ArtistContainer;
import com.tti.ttimediastore.dlna.dms.model.cling.localContent.AudioContainer;
import com.tti.ttimediastore.dlna.dms.model.cling.localContent.CustomContainer;
import com.tti.ttimediastore.dlna.dms.model.cling.localContent.ImageContainer;
import com.tti.ttimediastore.dlna.dms.model.cling.localContent.VideoContainer;
...
public class ContentDirectoryService extends AbstractContentDirectoryService
{
                               ...
                               SortCriterion[] orderby) throws ContentDirectoryException
	{
		...
		try
		{
			...
			if(sharedPref.getBoolean(Constants.CONTENTDIRECTORY_VIDEO, true))
			{
			...
			if(sharedPref.getBoolean(Constants.CONTENTDIRECTORY_AUDIO, true))
			{
			...
			if(sharedPref.getBoolean(Constants.CONTENTDIRECTORY_IMAGE, true))
			{
