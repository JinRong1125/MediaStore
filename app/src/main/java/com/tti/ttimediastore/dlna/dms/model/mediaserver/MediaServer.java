...
import com.tti.ttimediastore.dlna.dms.elonen.SimpleWebServer;
...
public class MediaServer extends SimpleWebServer
{
	...
	public MediaServer(InetAddress localAddress, Context ctx) throws ValidationException
	{
		...
		udn = Utils.Preferences.getDmsUDN();
...
//		}
	...
	public void createLocalDevice() throws ValidationException
	{
		...
		DeviceDetails details = new DeviceDetails(
				Utils.getSettingContentDirectoryName(ctx),
				new ManufacturerDetails(ctx.getString(R.string.app_name)),
				new ModelDetails(ctx.getString(R.string.app_name)),
